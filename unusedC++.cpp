...
int main() {
  ...
  for(;;) {
    ...
    if (cmd == "cls") {
      ...
      cout << "pls anter ur culhax key\n";
      cin >> key;
      if (key == accept) {
        cout << "hi\n";
        cout << "wat gaem yu hac/\n";
        cout << "mincraf or mincraf/\n";
        cin >> gaem;
        if (gaem == "mincraf") {
          cout << "hacing mincraf manfraim";
          cout << ".";
          sleep(3);
          cout << ".";
          sleep(3);
          cout << ".\n";
          sleep(3);
          cout << "beep boop minecoin and haker mod added\n";
          cout << "tanku 4 yousing calhasx\n";
        } else {
          cout << "sory can t hac gaem. can hack mincraf and mincraf";
        }
      }
    }else if (cmd == "passtest") {
      cout << "Enter username\n";
      cin >> enter;
      if (enter == user) {
        cout << "Enter password\n";
